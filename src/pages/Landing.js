...
const Landing = () => {
  ...
  const handleEdit = async (id) => {
    try {
      ...
      const res = await axios.put(
        `http://localhost:4000/todo/edittodo/${id}`,
        {
          title: newtodo,
        },
        {
  ...
  const addTask = async (e) => {
    try {
      e.preventDefault();
      const res = await axios.post(
        `http://localhost:4000/todo/createtask/${taskid}`,
        { task: task },
        {
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
        }
  ...
  const handleTaskDelete = async (e) => {
    try {
      ...
      console.log(text);
      const res = await axios.delete(
        `http://localhost:4000/todo/deletetask/${taskid}`,
        {
  ...
  }, [showtask, todoAdded, todoDeleted, taskAdded, taskDeleted, todoEditted]);
  ...
  return (
    <>
      ...
      <header className="p-4 bg-gray-100 text-gray-800">
        <div className="container flex flex-col md:flex-row text-center space-y-2 md:space-y-0 justify-between h-16 mx-auto">
          ...
          <form
            ...
            className="flex space-x-2 flex-row md:items-center md:space-x-4 mx-auto"
          >
            ...
            <button
              type="submit"
              className="px-6 py-2 font-semibold rounded lg:block bg-indigo-600 text-gray-50"
            >
              Add Todo
            </button>
          </form>
      ...
      <div className="conatiner p-2 mx-auto sm:p-4 text-gray-800">
        <h2 className="mb-4 text-center md:text-left text-2xl font-semibold leading-tight">
          Todos
        </h2>
        <ul className="list-none mx-auto md:mx-0 flex flex-row w-80 justify-evenly text-center items-center font-semibold m-3">
          Sort by Date:
          <li
            className="cursor-pointer border rounded-xl shadow-lg p-1 border-gray-500 bg-indigo-600 text-white"
            onClick={() => sort(1)}
          >
            Oldest
          </li>
          ...
          <header className="p-4 bg-gray-100 text-gray-800">
            <div className="container flex justify-between h-16 mx-auto">
              ...
              >
                ...
                <button
                  type="submit"
                  className="hidden px-6 py-2 font-semibold rounded lg:block bg-indigo-600 text-gray-50"
                >
                  Add Task
                </button>
              </form>
